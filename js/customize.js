 ...
 if(window.location.href.indexOf("/register")>-1){
   setInterval(function(){
    $(".section-title.lines .text").html("Si vous n’êtes pas salarié(e) du groupe LVMH mais disposez d'un accés invité, merci de renseigner vos identifiants:");
    $(".login-providers .text").html("Si vous êtes salarié(e) du groupe LVMH merci de cliquer sur ce bouton:");
   },250);
   $(".toggle-form").hide;
