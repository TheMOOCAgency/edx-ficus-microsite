...
if len(TO_EMAILS) >= 1:
    ...
    for i in range(len(TO_EMAILS)):
        ...
        html = "<html><head></head><body><p>Bonjour,<br /><br />Vous êtes inscrit au cours « {course_name} ».<br /><br />Nous avons constaté que vous n’avez pas encore pris le temps de découvrir les contenus.<br /><br />De nombreuses vidéos, textes, activités et quiz sont à votre disposition, 24h/24, n’hésitez pas à les consulter !<br /><br />Et si vous rencontrez des difficultés de connexion, vous pouvez réinitialiser votre mot de passe en cliquant ici :<br /><a href=https://{site_name}{reset_password_link}>https://{site_name}{reset_password_link}</a><br /><br />L’équipe pédagogique</p></body></html>".format(course_name=course.display_name_with_default,site_name=site_name,reset_password_link=reset_password_link)
