...
# command saved in crontab -e on app2 serveur: 
# sudo -H -u edxapp /edx/bin/python.edxapp /edx/app/edxapp/edx-microsite/data-ready/utils/script_grades_report.py "clescop-ext@netexplo.org;eruch-ext@netexplo.org;tom.douce@weuplearning.com" course-v1:data-ready+v1+FR true false false true