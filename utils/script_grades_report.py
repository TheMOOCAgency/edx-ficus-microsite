...
# sudo -H -u edxapp /edx/bin/python.edxapp /edx/app/edxapp/edx-microsite/complete-data/utils/script.py "clescop-ext@netexplo.org;eruch-ext@netexplo.org;tom.douce@weuplearning.com" course-v1:complete-data+FR+v1 true false false true