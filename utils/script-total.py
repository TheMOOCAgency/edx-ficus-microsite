...
if domain_prefix == "moduleblanchiment":
    ...
    HEADERS = ["id","Username","Pays","Adresse mail","Client","Date d'inscription","Date dernière connexion"]
...
date_reference = datetime.datetime(2020, 8, 1).replace(tzinfo=utc)
...
for i in range(len(course_enrollement)):
    ...
    if user_enroll_date > date_reference:
        ...
        """
        primary_rows = [
            user.id,username,country,email,
