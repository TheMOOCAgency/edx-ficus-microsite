...
course_ids=[
    { "data-IA":
        [
            "course-v1:edf-netexploacademy+FR+V1",
            "course-v1:edf-netexploacademy+EN+V1",
            "course-v1:edf-netexploacademy+12+ES",
            "course-v1:edf-netexploacademy+13+DE"
        ]
    },
    { "expeditions":
        [
            "course-v1:edf-netexploacademy+Netexplo_expedition+2018_T2_expedition",
            "course-v1:edf-netexploacademy+Netexplo_expeditions_en+2018_T2_expeditions_en",
            "course-v1:edf-netexploacademy+expeditions+2020_es",
            "course-v1:edf-netexploacademy+expeditions+2020_de"
        ]
    },
    
    { "journey":
        [
            "course-v1:edf-netexploacademy+Netexplo_voyages+2018_T2_voyages",
            "course-v1:edf-netexploacademy+Netexplo_travel+2018_T2_travel",
            "course-v1:edf-netexploacademy+travel+2020_es",
            "course-v1:edf-netexploacademy+travel+2020_de"
        ]
    },
    { "manager":
        [
            "course-v1:edf-netexploacademy+parcours-manager-fr+parcours-manager-fr",
            "course-v1:edf-netexploacademy+manager+manager-en",
            "course-v1:edf-netexploacademy+manager+manager-es",
            "course-v1:edf-netexploacademy+manager+manager-de"
        ]
    },
    {"passeport":
        [
            "course-v1:edf-netexploacademy+Netexplo_passeport+2018_T2_passeport",
            "course-v1:edf-netexploacademy+Netexplo_passeport_EN+2018_T2_passeport_EN",
            "course-v1:edf-netexploacademy+data_ia+2020_ES",
            "course-v1:edf-netexploacademy+data_ia+2020_DE"
        ]
    },
    { "social-school":
        [
            "course-v1:edf-netexploacademy+socialschoolfr+SSFR",
            "course-v1:edf-netexploacademy+socialschoolen+SSEN",
            "course-v1:edf-netexploacademy+socialschoolen+SSES",
            "course-v1:edf-netexploacademy+socialschoolen+SSDE"
        ]
    }
]
...
for user in users_data:
    ...
    for i in range(len(user_data)):
        try:
            ...
            pass
    j = j + 1
wb.save('/edx/var/edxapp/media/microsite/edf-netexploacademy/reports/{}_EDF_NETEXPLO_ACA.xls'.format(time.strftime("%d.%m.%Y")))
log.info('[WUL] : Global report file written')

# delete old files
two_days_ago = datetime.today() - timedelta(days=1)
try:
    os.remove('/edx/var/edxapp/media/microsite/edf-netexploacademy/reports/{}_EDF_NETEXPLO_ACA.xls'.format(two_days_ago.strftime("%d.%m.%Y")))
except:
    pass