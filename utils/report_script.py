...
# TEST 
# sudo -H -u edxapp /edx/bin/python.edxapp /edx/app/edxapp/edx-microsite/lvmh-elearninginternalcontrol/utils/report_script.py "cyril.adolf@weuplearning.com" course-v1:lvmh-elearninginternalcontrol+EN+2022 
